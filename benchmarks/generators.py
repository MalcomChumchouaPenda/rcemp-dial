...
class Dialysis2021Generator(BenchmarkGenerator):
    ...
    def _generate_maintenances(self, session, problem, machines_group, maintenance_slots):
        ...
        for j in range(nb_mainteners):
            ...
            cm3 = CM(uid=f2(), ressource=mr, capability=1, activity='R3')
            cm4 = CM(uid=f2(), ressource=mr, capability=1, activity='R4')
            cm5 = CM(uid=f2(), ressource=mr, capability=1, activity='R5')
            cm6 = CM(uid=f2(), ressource=mr, capability=1, activity='R6')
            cm7 = CM(uid=f2(), ressource=mr, capability=1, activity='R7')
            cm8 = CM(uid=f2(), ressource=mr, capability=1, activity='R8')
            cm9 = CM(uid=f2(), ressource=mr, capability=1, activity='R9')
            cm10 = CM(uid=f2(), ressource=mr, capability=1, activity='R10')
            cm11 = CM(uid=f2(), ressource=mr, capability=1, activity='R11')
            cm12 = CM(uid=f2(), ressource=mr, capability=1, activity='R12')
            cm13 = CM(uid=f2(), ressource=mr, capability=1, activity='R13')
            cm14 = CM(uid=f2(), ressource=mr, capability=1, activity='R14')
            cm15 = CM(uid=f2(), ressource=mr, capability=1, activity='R15')
    ...
    def _generate_machines(self, session, problem, machines_group, production_slots):   
        ...
        for i in range(machines_group.shape[0]):
            ...
            dev1 = Dev(uid=dv_id(), name='Dv1', repair_skill='R1', json_law=law_g(), repair_time=1, **kwargs)
            dev2 = Dev(uid=dv_id(), name='Dv2', repair_skill='R2', json_law=law_g(), repair_time=1, **kwargs)
            dev3 = Dev(uid=dv_id(), name='Dv3', repair_skill='R3', json_law=law_g(), repair_time=1, **kwargs)
            dev4 = Dev(uid=dv_id(), name='Dv4', repair_skill='R4', json_law=law_g(), repair_time=1, **kwargs)
            dev5 = Dev(uid=dv_id(), name='Dv5', repair_skill='R5', json_law=law_g(), repair_time=1, **kwargs)
            dev6 = Dev(uid=dv_id(), name='Dv6', repair_skill='R6', json_law=law_g(), repair_time=1, **kwargs)
            dev7 = Dev(uid=dv_id(), name='Dv7', repair_skill='R7', json_law=law_g(), repair_time=1, **kwargs)
            dev8 = Dev(uid=dv_id(), name='Dv8', repair_skill='R8', json_law=law_g(), repair_time=1, **kwargs)
            dev9 = Dev(uid=dv_id(), name='Dv9', repair_skill='R9', json_law=law_g(), repair_time=1, **kwargs)
            dev10 = Dev(uid=dv_id(), name='Dv10', repair_skill='R10', json_law=law_f(), repair_time=1, **kwargs)
            dev11 = Dev(uid=dv_id(), name='Dv11', repair_skill='R11', json_law=law_g(), repair_time=1, **kwargs)
            dev12 = Dev(uid=dv_id(), name='Dv12', repair_skill='R12', json_law=law_g(), repair_time=1, **kwargs)
            dev13 = Dev(uid=dv_id(), name='Dv13', repair_skill='R13', json_law=law_g(), repair_time=1, **kwargs)
            dev14 = Dev(uid=dv_id(), name='Dv14', repair_skill='R14', json_law=law_g(), repair_time=1, **kwargs)
            dev15 = Dev(uid=dv_id(), name='Dv15', repair_skill='R15', json_law=law_g(), repair_time=1, **kwargs)
