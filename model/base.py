...
from tools import benchmarks as gen
...
class BasicModel(Model):
    ...
    def __init__(self, benchmark_id, problem_id, verbose=None, seed=None):
        ...
        benchmarkcls = getattr(gen, benchmark_id)
        benchmark = benchmarkcls(verbose=verbose)
        self.benchmark = benchmark
        self.session = benchmark.open_session()
        self.experiment = benchmark.generate_experiment(model_name, problem_id)      
        self.logger = get_logger(self.experiment.name, verbose=verbose)
